...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lnav-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lnav-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `lnav` available on your platform:
...
```
pixi search lnav --channel conda-forge
```
